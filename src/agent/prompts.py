"""AWS Architecture Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are AWS Architecture Agent, a cloud architecture specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to AWS Architecture Agent operations:
...
REPORT_PROMPT = """Generate a structured report for AWS Architecture Agent:
