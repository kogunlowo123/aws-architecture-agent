"""AWS Architecture Agent - Domain-Specific Connectors."""
...
class TerraformCliConnector:
    """Domain-specific connector for terraform cli integration with AWS Architecture Agent."""
...
class AwsProviderConnector:
    """Domain-specific connector for aws provider integration with AWS Architecture Agent."""
...
class AzureProviderConnector:
    """Domain-specific connector for azure provider integration with AWS Architecture Agent."""
...
class GcpProviderConnector:
    """Domain-specific connector for gcp provider integration with AWS Architecture Agent."""
...
class InfracostConnector:
    """Domain-specific connector for infracost integration with AWS Architecture Agent."""
