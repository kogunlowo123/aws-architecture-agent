"""AWS Architecture Agent - Unit Tests."""
...
async def test_design_architecture():
    """Test Design cloud architecture for AWS Architecture Agent."""
    tools = AgentTools()
...
async def test_agent_initialization():
    ...
    from src.agent.aws_architecture_agent_agent import AwsArchitectureAgentAgent
    agent = AwsArchitectureAgentAgent()
